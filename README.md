...
- `specs/grubhub-notifications-api.yaml` is the Git source of truth for the service contract.
...
- `[GH] GrubHub Notifications API`

## Repo Source

- `shivemind/grubhub-notifications-api`
